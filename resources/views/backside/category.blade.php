    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3 class="mmfont">ပစ္စည်းအမျိုးအစား</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item mmfont"><a href="{{ route('dashboard') }}">ပင်မစာမျက်နှာ</a></li>
                        <li class="breadcrumb-item mmfont active" aria-current="page">ပစ္စည်းအမျိုးအစား</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <form>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name" class="mmfont"> ပစ္စည်းအမျိုးအစား </label>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.createBtn').on('click', function(){
                ...
                $("#exampleModalCenterTitle").text('ပစ္စည်းအမျိုးအစား အသစ် ထည့်ရန် ');
            });
            ...
            $("#showModal").on('submit','#addForm',function(e){
                ...
                $.ajax({
                    ...
                    success: (data) => { 
                        Swal.fire({
                            icon: "success",
                            text: "ပစ္စည်းအမျိုးအစား အချက်အလက်များ အောင်မြင်စွာသိမ်းဆည်းပြီးပါပြီ",
                            buttons: false,
                            timer : 1500
                        });
            ...
            $('tbody').on('click', '.editBtn', function (){
                ...
                $("#exampleModalCenterTitle").text('ပစ္စည်းအမျိုးအစား ပြင်ဆင် ရန် ');
            ...
            $('tbody').on('click', '.deleteBtn', function () {
                ...
                Swal.fire({
                text: "ထိုပစ္စည်းအမျိုးအစားကို စာရင်းမှပယ်ဖျက်မည်!",
                icon: "warning",
                ...
                dangerMode: true}).then((willDelete)=>{
                    ...
                    if (willDelete.isConfirmed != false) 
                    {
                        Swal.fire({
                            icon: "success",
                            text: "ထိုပစ္စည်းအမျိုးအစား အချက်အလက်များကိုအောင်မြင်စွာဖျက်ပစ်လိုက်ပြီ",
                            buttons: false,
                            timer : 1500
                        }).then(
                            function()
                    ...
                    else
                    {
                        Swal.fire({
                            icon: "info",
                            text: "ထိုပစ္စည်းအမျိုးအစား အချက်အလက်များသည်လုံခြုံစွာရှိနေပါသေးသည်။",
                            buttons: false,
                            timer : 1500
                        });
